...
class Bulb_ALT:
    def __init__(self):
        """初始化数据"""
        data = {
            '6.3 V': [181.3, 288.4, 1178, 1511, 1706, 1723, 1964, 3157, 3224, 3483, 3555, 4939, 5443, 7807],
            '6.5 V': [108.2, 335, 433.1, 496.4, 541.2, 820.6, 922.3, 928.6, 1053, 1517, 1520, 1952, 1954, 5176],
            '7.0 V': [39.68, 212.3, 250.8, 261.3, 320.9, 374.8, 524.6, 626.6, 724.6, 830.8, 884.6, 1113, 1301, 1303],
            '7.5 V': [59.06, 74.06, 134.9, 180.1, 201.4, 226.5, 235.3, 237, 281.5, 288.1, 356.1, 420.5, 513.2, 533.9],
    ...
    def plot_failure_data(self):
        ...
        plt.savefig('C1-fig0-失效数据示意图.png', dpi=300)
